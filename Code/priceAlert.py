...
def PriceAlert():
    ...
    def quote_grab(symbol):
        ...
        namestr = re.compile(
            '.*name:\"' + symbol + '\",cp:(.*),p:(.*?),cid(.*)')  # "?" used as there is a second string "cid" in the page and the Match was being done up to that one. The "?" keeps it to the 1st occurrence.
    ...
    def pushover(msg):
        ...
        conn.request("POST", "/1/messages.json",
                     urllib.urlencode({
                         ...
                         "user": "u588rew7qyh1m5xozz8jj9ht4th94c",
                         "message": msg,
